...
import (
	...
	model "github.com/zerok-ai/zk-utils-go/scenario/model"
)
...
func (_m *ScenarioRepo) GetAllScenario(filters *repository.ScenarioQueryFilter) (*[]model.Scenario, *[]string, error) {
	ret := _m.Called(filters)

	var r0 *[]model.Scenario
	var r1 *[]string
	var r2 error
	if rf, ok := ret.Get(0).(func(*repository.ScenarioQueryFilter) (*[]model.Scenario, *[]string, error)); ok {
		return rf(filters)
	}
	...
	if rf, ok := ret.Get(2).(func(*repository.ScenarioQueryFilter) error); ok {
		r2 = rf(filters)
	} else {
		r2 = ret.Error(2)
	}
