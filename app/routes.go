...
func Initialize(app router.Party, rh scenarioHandler.ScenarioHandler, ih integrationsHandler.IntegrationsHandler, ah handler.AttributeHandler, oh obfuscationHandler.ObfuscationHandler) {
	{
