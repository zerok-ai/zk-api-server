...
func ConvertPixieDataToServiceMap(r *types.Record) ServiceMap {
	...
	serviceMap.ResponderPod = utils.GetStringFromRecord("responder_pod", r)
	serviceMap.RequesterPod = utils.GetStringFromRecord("requestor_pod", r)
	serviceMap.ResponderService = utils.GetStringFromRecord("responder_service", r)
	serviceMap.RequesterService = utils.GetStringFromRecord("requestor_service", r)
	serviceMap.ResponderIP = utils.GetStringFromRecord("responder_ip", r)
	serviceMap.RequesterIP = utils.GetStringFromRecord("requestor_ip", r)
